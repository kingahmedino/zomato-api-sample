...
object DataRepository {
    ...
    fun getRestaurants(query: String) {
        ...
        BackEnd().getRestaurants(
            "1b3c8b37ea96785391fa55c288ac385c",
            ...
            .enqueue(object : Callback<ResponseBody> {
                ...
                override fun onResponse(
                    ...
                    if (response.isSuccessful) {
                        mutableLiveResponse.value =
                            getRestaurantsFromJSON(response.body()?.string())
                        mDataRepoListener?.onSuccess(mutableLiveResponse)
                    } else {
                        mDataRepoListener?.onFailure("An error occurred")
                    }
                }
